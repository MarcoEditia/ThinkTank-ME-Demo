        ...
        if sidebar_chats:
            for chat in sidebar_chats:
                ...
                if st.button(title, key=session_id, width="stretch"):
                    # ON CLICK: Now we actually hit the database for the heavy messages
...
if prompt := st.chat_input("Ask a question..."):
    ...
    # Mock LLM Response (Replace with your API call later)
    ...
    # We use a default title "New Chat" just in case, but overwrite it with the prompt
